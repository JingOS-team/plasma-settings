...
RowLayout {
    ...
    QQC2.Slider {
        ...
        QQC2.Label {
            ...
            z: slider.z - 1
            x: (Qt.application.layoutDirection
                == Qt.RightToLeft ? slider.width - hundredPos : hundredPos) - width / 2
            y: slider.height
    ...
    QQC2.Label {
        ...
        readonly property real value: PulseObject.volume
                                      > slider.maximumValue ? PulseObject.volume : slider.value
        readonly property real displayValue: Math.round(
                                                 value / PulseAudio.NormalVolume * 100.0)
