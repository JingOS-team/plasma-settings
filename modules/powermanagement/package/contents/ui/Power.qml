    ...
    ColumnLayout {
        ...
        Row {
            ...
            Controls.Slider {
                ...
                onValueChanged: {
                    acBrightnessConfig.writeEntry("value",
                                                  Math.round(value * 100))
                    batteryBrightnessConfig.writeEntry("value",
                                                       Math.round(value * 100))
                    lowBatteryBrightnessConfig.writeEntry("value", Math.round(
                                                              value * 100))

                    var service = pmSource.serviceForSource("PowerDevil")
                    var operation = service.operationDescription(
                                "setBrightness")
        ...
        Row {
            ...
            Controls.Switch {
                ...
                onCheckedChanged: screensaverConfig.writeEntry(
                                      "Enabled", checked ? "true" : "false")
                Component.onCompleted: checked = screensaverConfig.readEntry(
                                           "Enabled") == "true"
            }
            ...
            Controls.Slider {
                ...
                onValueChanged: {
                    if (screensaverEnabledSwitch.checked) {
                        screensaverConfig.writeEntry("Timeout",
                                                     Math.round(value) * 60)
                    }
                }

                Component.onCompleted: value = screensaverConfig.readEntry(
                                           "Timeout") / 60
            }
            ...
            Controls.Label {
                ...
                text: i18np("%1 minute", "%1 minutes",
                            screensaverTimeSlider.value)
            }
        }
        ...
        Row {
            ...
            Controls.Switch {
                ...
                onCheckedChanged: {
                    if (checked) {
                        batteryDpmsConfig.writeEntry(
                                    "idleTime",
                                    Math.round(dpmsTimeSlider.value) * 60)
                        lowBatteryDpmsConfig.writeEntry(
                                    "idleTime",
                                    Math.round(dpmsTimeSlider.value) * 60)
                        acDpmsConfig.writeEntry("idleTime", Math.round(
                                                    dpmsTimeSlider.value) * 60)
                    } else {
                ...
                Component.onCompleted: checked = batteryDpmsConfig.readEntry(
                                           "idleTime") > 0
            }
            ...
            Controls.Slider {
                ...
                onValueChanged: {
                    if (dpmsSwitch.checked) {
                        batteryDpmsConfig.writeEntry("idleTime",
                                                     Math.round(value) * 60)
                        lowBatteryDpmsConfig.writeEntry("idleTime",
                                                        Math.round(value) * 60)
                        acDpmsConfig.writeEntry("idleTime",
                                                Math.round(value) * 60)
                    }
                }

                Component.onCompleted: value = batteryDpmsConfig.readEntry(
                                           "idleTime") / 60
            }
